...
const Cursos = () => {
  ...
  useEffect(() => {
    ...
    axios
      .all([
        axios.get("https://api.example.com/cursos/curso1"),
        axios.get("https://api.example.com/cursos/curso2"),
        axios.get("https://api.example.com/cursos/curso3"),
      ])
      .then((responses) => {
